...
function showPwaPopup() {
    ...
    overlay.innerHTML = `
        <div style="background: #fff; padding: 30px; border-radius: 20px; text-align: center; max-width: 350px; margin: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
            <h4 style="color: #333; margin-bottom: 10px;">Instalar Portfólio</h4>
            <p style="color: #666; margin-bottom: 20px;">Aceda ao meu site como um aplicativo diretamente do seu ecrã inicial!</p>
